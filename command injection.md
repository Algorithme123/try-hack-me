...
```
root@kk:~# git clone https://github.com/ismailtasdelen/command-injection-payload-list.git
```

### Cloning an Existing Repository ( Clone with SSH )
```
root@kk:~# git clone git@github.com:ismailtasdelen/command-injection-payload-list.git
```
